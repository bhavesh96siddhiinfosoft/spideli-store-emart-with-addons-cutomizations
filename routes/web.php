...
Route::middleware(['check.subscription'])->group(function () {
    ...
    // Subscriptions a store sells to its own customers - distinct from
    // subscription-plan/my-subscriptions, which the store buys from the platform.
    Route::get('/customer-subscriptions', [App\Http\Controllers\CustomerSubscriptionController::class, 'index'])->name('customer-subscriptions');

    Route::get('/customer-subscriptions/create', [App\Http\Controllers\CustomerSubscriptionController::class, 'create'])->name('customer-subscriptions.create');

    Route::get('/customer-subscriptions/subscribers', [App\Http\Controllers\CustomerSubscriptionController::class, 'subscribers'])->name('customer-subscriptions.subscribers');

    Route::get('/customer-subscriptions/payments', [App\Http\Controllers\CustomerSubscriptionController::class, 'payments'])->name('customer-subscriptions.payments');

    Route::get('/customer-subscriptions/edit/{id}', [App\Http\Controllers\CustomerSubscriptionController::class, 'edit'])->name('customer-subscriptions.edit');
