{{-- Create a store. The form and its behaviour are shared with edit; no
     storeId is passed, which the save reads as "make a new one". --}}
@extends('layouts.app')
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{ trans('lang.store_create') }}</li>
            </ol>
        </div>
