    ...
    <body>
        ...
        <div id="app" class="fix-header fix-sidebar card-no-border">
            ...
            <div id="main-wrapper">
                ...
                {{-- Before the header and the menu, both of which call these while
                     they run. The menu asks whether the store is subscribed as
                     soon as Firestore answers, which on a cached answer is
                     sooner than the rest of the page parses. --}}
