...
<div class="page-wrapper">
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{!! route('booktable') !!}">{{trans('lang.book_table_table')}}</a>
                </li>
    ...
    <div>
        ...
        <div class="card-body">
            ...
            <div class="row restaurant_payout_create">
                ...
                <div class="restaurant_payout_create-inner">
                    ...
                    <fieldset>
                        <legend>{{trans('lang.dine_in_booking_history')}}</legend>
                        ...
                        <div class="form-group row width-50">
                            <div class="col-7">
                                <input class="form-control guest_first_name" id="guest_name" type="text"
                                    placeholder="{{trans('lang.first_name')}}" disabled>
                            </div>
                        </div>

                        <div class="form-group row width-50">
                            <div class="col-7">
                                <input class="form-control guest_last_name" type="text" placeholder="{{trans('lang.last_name')}}"
                                    disabled>
                            </div>
                        </div>
                        ...
                        <div class="form-group row width-100">
                            <label class="col-3" for="birthday_occasion">{{trans('lang.spectal_occasion')}}</label>
                        ...
                        <div class="form-group row col-12">
                            <label for="discount control-label">{{trans('lang.discount')}}: <span id="discount"></span></label>
                        </div>
        ...
        <div class="form-group col-12 text-center btm-btn">
            <button type="button" class="btn btn-primary save_booking_btn"><i class="fa fa-save"></i>
                {{ trans('lang.save')}}</button>
            <a href="{!! route('booktable') !!}" class="btn btn-default"><i
    ...
    $(document).ready(function() {
        ...
        ref.get().then(async function(snapshots) {
            ...
            try {
                ...
                $(".event_date").val(book.date.toDate().toLocaleString());
                ...
                var discount = book.discount ? `
                    ${currencyAtRight 
                        ? book.discount + (book.discountType == "percentage" ? '%' : currentCurrency)
                        : (book.discountType == "percentage" ? book.discount + '%' : currentCurrency + book.discount)
                    } ` : ``;
                $("#discount").text(discount);

                try {
                    if (book.occasion != undefined && book.occasion.trim() != '' && !isNaN(book
                            .occasion)) {
        ...
        $(".save_booking_btn").click(function() {
            ...
            database.collection('booked_table').doc(id).update({
                ...
                database.collection('users').where('id', '==', auth).get().then(function(
                    snapshots) {
