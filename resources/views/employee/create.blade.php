                        ...
                        .then(async function(firebaseUser) {
                                 ...
                                 $.ajax({
                                    ...
                                    success: function (data) {
                                        if (data.access) {
                                            ...
                                            $(".error_top").show();
                                            $(".error_top").html("");
                                            $(".error_top").append("<p>{{trans('lang.failed_to_set_token')}}</p>");
                                        }
                                    },
                                    error: function () {
                                        jQuery('#data-table_processing').hide();
                                        $(".error_top").show();
                                        $(".error_top").html("");
                                        $(".error_top").append("<p>{{trans('lang.an_error_occurred_while_setting_the_token')}}</p>");
                                    }
                                });
                            ...
                            switch (error.code) {
                                case 'auth/email-already-in-use':
                                    message = "{{ trans('lang.email_already_in_use') }}";   
                                    break;
                                ...
                                case 'auth/weak-password':
                                    message = "{{ trans('lang.password_too_weak') }}";     
                                    break;
                                case 'auth/operation-not-allowed':
                                    message = "{{ trans('lang.email_password_signup_not_enabled') }}";
                                    break;
                                ...
                                case 'auth/too-many-requests':
                                    ...
                                    break;
                                default:                           
                                    message = "{{ trans('lang.failed_to_create_account') }} " + 
                                        (error.message ? error.message.replace(/Firebase: Error \([^)]+\)\./, '') : '');
                            }
                            jQuery("#data-table_processing").hide();
                            $(".error_top").show();
                            $(".error_top").html("");
