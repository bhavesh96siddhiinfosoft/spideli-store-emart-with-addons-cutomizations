                                                ...
                                                <div class="form-group row width-100">
                                                    ...
                                                    <div class="col-7">
                                                        <select class="form-control advertisement_type" id="advertisement_type">
                                                            ...
                                                            <option value="restaurant_promotion">{{ trans('lang.store_promotion') }}</option>
    ...
    <script>
        ...
        async function handleVideoSelect(evt) {
            ...
            if (f.size > maxSize) {
                $(".error_top").show();
                $(".error_top").html("");
                $(".error_top").append("<p>{{trans('lang.error_file_size')}}</p>");
                window.scrollTo(0, 0);
                isVideo.value = '';
                return false;
            }
            ...
            video.onloadedmetadata = function() {
                ...
                if (width > (height * 1.7)) {
                    ...
                    $(".error_top").show().html("<p>{{trans('lang.error_landscape_video')}}</p>");
                    window.scrollTo(0, 0);
                    isVideo.value = '';
                    return false;
                }
