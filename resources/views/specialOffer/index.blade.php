                                        ...
                                        <div class="special_offer_div">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-12 control-label"
                                                       style="color:red;font-size:15px;">{{trans('lang.please_click_on_edit_button')}} </label>
                                            </div>
                                            <div class="form-group row">
...
<script type="text/javascript">
    ...
    $(".save_special_offer_btn").click(function () {
        ...
        database.collection('vendors').doc(vendorId).update({'specialDiscount': specialDiscount,specialDiscountEnable:enabledSpecialOffer}).then(function (result) {
